...
const pricingPlans = [
  {
    ...
    description: 'نرم افزار مدیریت استراتژیک پوینتر بهترین انتخاب برای شرکت های با سایز متوسط و کوچک است که برنامه ریزی چابک و مدیریت پروژه اهمیت ویژه ای برای آنها داشته و در جاری سازی استراتژی خود از متدهای agile بهره می گیرند.',
  ...
  },
  {
    ...
    description: 'نرم افزار جاری سازی استراتژی پوینتر برای خدمت به سازمان های بزرگی که نیازمند ابزاری جهت ایجاد همراستایی بدنه سازمان در راستای اهداف استراتژیک و چشم انداز ها و ارزیابی علکرد هستند.',
  ...
  },
  {
    ...
    description: 'نرم افزار مدیریت استراتژیک پوینتر، مناسب برای سازمان هایی که دارای محرمانگی اطلاعات می باشند و تمایل دارند که مدیریت استراتژیک و مدیریت پروژه های خود را با اطمینان کامل بر روی پلتفرم خود و بر روی سرورهای داخلی خود سازمان انجام دهند',
