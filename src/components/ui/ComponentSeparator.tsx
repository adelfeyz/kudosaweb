    ...
    >
      <div className="flex items-center justify-center gap-2">
        ...
        <div className="relative flex items-center justify-center">
          ...
          {/* Corner dots */}
          <div className="absolute -top-1 -start-1 w-1 h-1 rounded-full bg-primary/40" />
          <div className="absolute -top-1 -end-1 w-1 h-1 rounded-full bg-primary/40" />
          <div className="absolute -bottom-1 -start-1 w-1 h-1 rounded-full bg-primary/40" />
          <div className="absolute -bottom-1 -end-1 w-1 h-1 rounded-full bg-primary/40" />
        </div>
