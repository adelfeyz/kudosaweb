# Setup Cloudflare Pages - Step by Step

This guide shows how to set up Cloudflare Pages for the Pointer website in your **New account**.
...
## Step 2: Click "Create a Worker" and Find Pages Link
...
### Node.js Version
- **Node version**: `22` (or latest LTS like `20`)
...
1. Get your Pages URL from Step 5
...
1. Visit your Pages URL: `https://pointer-website.pages.dev`

2. Test API connection:
   - Open browser console
   - Check for API calls to `https://unified-api.alexfeyz82.workers.dev`
...
### Can't find "Pages" tab in Create Application
- **Make sure you clicked "Create application"**: Not "Create worker" or "Create a project"
- **Look for tabs**: The modal should have both "Workers" and "Pages" tabs at the top
- **Click the "Pages" tab**: It's not selected by default
- **If only Workers tab appears**: Your account might need Pages enabled, or try refreshing
...
1. ✅ **Test all functionality** (forms, API calls, database)
2. ✅ **Set up custom domain** (if needed)
3. ✅ **Configure SSL/TLS** (automatic with Cloudflare)
4. ✅ **Monitor deployments** and set up notifications

---

*Last Updated: After Pages setup*
*Version: 1.0*
